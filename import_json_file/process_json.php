...
$file = __DIR__ . '/unprocessed/students.json';

// Generator to access Json file as an associative array one line at a time
...
foreach (processJson($file) as $row) {
...
$newName = __DIR__ . '/processed/' . (new DateTime())->format('Ymd_His') . '.json';
rename($file, $newName);
